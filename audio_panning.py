...
#    print sd1_target
   ...
   #DO SOUND SETUP HERE
    ...
    threshold1 = bl_mean-2*bl_std
    threshold2 = bl_mean+2*bl_std
    sig1 = Sine(mul=.5); 

    p1 = Pan(sig1, outs=2, pan=1).out()
    ...
    while routine_helper.get_status() and routineTimer.getTime() > 0:
        ...
        #-----------------------------------------------------------
        # GENERATE SOME NOISE HERE
        #use psizeliste[] to access values
        if lmarker == 0:
